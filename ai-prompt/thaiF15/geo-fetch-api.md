...
# Final FE‑only Implementation (Rewrite Proxy to avoid CORS)

> Bản chốt: gọi trực tiếp public endpoints của **tinhthanhpho.com/api/v1** từ FE, né CORS bằng **Next.js rewrites**. Không đụng API key, không cần BE.
...
## 5) (tuỳ chọn) Provider cho React Query
...
# AI Prompt (copy & paste để mở rộng/tùy biến)
