...
export function SearchBar({ className }: SearchBarProps) {
  ...
  return (
    <div className={`w-full bg-gradient-to-r from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-md border-b border-white/10 ${className}`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div className="flex flex-col lg:flex-row gap-4 items-center">
          ...
          <div className="relative min-w-[200px]">
            ...
            >
              <option value="" className="bg-slate-800 text-white">Tất cả địa điểm</option>
          ...
          <div className="relative min-w-[200px]">
            ...
            <select
              ...
              className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 text-white rounded-xl backdrop-blur-sm appearance-none focus:bg-white/20 focus:border-white/40"
            >
              <option value="" className="bg-slate-800 text-white">Tất cả thương hiệu</option>
              {brands.map((brand) => (
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          {['Tesla Model 3', 'BYD Atto 3', 'VinFast VF8', 'Pin 60kWh', 'Pin 100kWh'].map((tag) => (
            <button
              key={tag}
