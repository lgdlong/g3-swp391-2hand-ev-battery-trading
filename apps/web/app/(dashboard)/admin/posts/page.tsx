...
import { getAdminPosts, approvePost, rejectPost, getPostDetail } from '@/lib/api/postApi';
...
export default function AdminPostsPage() {
  ...
  const handleViewDetails = async (post: Post) => {
    try {
      // Fetch full post details including images and address
      const fullPostDetails = await getPostDetail(post.id);
      console.log('Full post details:', fullPostDetails);
